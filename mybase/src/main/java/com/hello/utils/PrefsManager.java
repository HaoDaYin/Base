...
public class PrefsManager
{
	...
	{
		return this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).contains(
				PrefsManager.PERFERENCE_NAME);
	}

	public Boolean getBoolean(final String key)
	{
		return this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).getBoolean(key,
				false);
	}
	...
	{
		return this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).getFloat(key,
				0.0f);
	}
	...
	{
		return this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).edit()
	 ...
	 */
	 public void remove()
	{
		this.mContext.getSharedPreferences(PrefsManager.PERFERENCE_NAME, Context.MODE_PRIVATE).edit()
		.remove(PrefsManager.PERFERENCE_NAME).commit();
	}
